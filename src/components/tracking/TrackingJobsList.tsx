  ...
  if (jobs.length === 0) {
    return (
      <div className="card flex flex-col items-center gap-3 py-12 text-center">
        ...
        <p className="text-sm font-medium text-stone-600">No active tracking</p>
        <p className="text-xs text-stone-400">Tracking will appear when a worker is on the way</p>
      </div>
    );
  }
      ...
      {jobs.map((job) => (
        ...
        >
          <div className="card transition-all active:scale-[0.98]">
            ...
            <div className="mt-3 flex items-center justify-center gap-2 rounded-xl bg-stone-50 px-3 py-2.5">
              <svg className="h-4 w-4 text-[#0e5f44]" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" d="M15 10.5a3 3 0 11-6 0 3 3 0 016 0z" />
                <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z" />
              </svg>
