    ...
    try {
        ...
        if (contentType.includes("multipart/form-data")) {
            ...
            payload = {
                ...
                clarification: typeof body?.clarification === "string"
                    ? body.clarification
                    : undefined,
                location: parseLocation(body?.lat, body?.lng),
            };
    ...
    try {
        ...
        if (payload.audio) {
            try {
                ...
                return fail(res, "Could not understand the audio — it may be too short or unclear. Please type your request instead.", 422);
            }
        }
        ...
        const category = understood.understanding.category;
        const workers = await getWorkerOptions({
            category,
            required_skills: understood.understanding.required_skills,
            urgency: (understood.understanding.urgency ?? "normal"),
            limit: 4,
