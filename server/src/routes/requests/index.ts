 ...
 */
router.get("/list", requireRole(["customer"]), async (req: Request, res: Response) => {
  const sessionUser = res.locals.sessionUser;
 ...
 */
router.post("/respond", requireRole(["worker"]), async (req: Request, res: Response) => {
  const sessionUser = res.locals.sessionUser;
 ...
 */
router.post("/counter-response", requireRole(["customer"]), async (req: Request, res: Response) => {
  const sessionUser = res.locals.sessionUser;
 ...
 */
router.post("/:id/respond", requireRole(["worker"]), async (req: Request, res: Response) => {
  const sessionUser = res.locals.sessionUser;
